...
import { Amenity, Apartment, ApartmentAmenity, ApartmentBed, ApartmentImage, ApartmentType, BedType, Review } from "../../database";
export type AmenitiesFilters = BaseFiltersOptions<Amenity> & {
    name?: string;
    description?: string;
};
export type CreateAmenity = CreativeOmit<Amenity> & {
    image?: string;
    file?: File;
};
export type UpdateAmenity = Partial<CreateAmenity> & {
    is_excluded?: boolean;
};
...
export type CreateApartment = CreativeOmit<Apartment> & {
    image?: string;
    file?: File;
};
...
export type UpdateApartmentAmenity = Partial<CreateApartmentAmenity> & {
    is_excluded?: boolean;
};
export type BedTypesFilters = BaseFiltersOptions<BedType> & {
    name?: string;
};
export type CreateBedType = CreativeOmit<BedType> & {
    image?: string;
    file?: File;
};
export type UpdateBedType = Partial<CreateBedType> & {
    is_excluded?: boolean;
};
...
export type UpdateApartmentBed = Partial<CreateApartmentBed> & {
    is_excluded?: boolean;
};
...
export type CreateApartmentImage = CreativeOmit<ApartmentImage> & {
    image?: string;
    file?: File;
};
export type UpdateApartmentImage = Partial<CreateApartmentImage> & {
    is_excluded?: boolean;
};
