...
export class CardDetailsFiltersDto
  extends BaseFiltersDto<CardDetail>
  implements CardDetailsFilters
{
  @ToUUID({
    required: false,
    description: 'User ID',
  ...
  @ToString({
    required: false,
    description: 'Card holder name (partial match)',
    example: 'John Doe',
    min: 3,
    max: 255,
  })
  ...
  @ToString({
    required: false,
    description: 'Card token (for payment gateway)',
    example: 'tok_1J8A9L2eZvKYlo2CYVx2rFxH',
    min: 3,
    max: 255,
  })
  token?: string;
