...
export class ApartmentBedsFiltersDto
  extends BaseFiltersDto<ApartmentBed>
  implements ApartmentBedsFilters
{
  @ToUUID({
    required: false,
  ...
  @ToInt({
    required: false,
    min: 1,
    description: 'Minimum beds count',
    example: 1,
  })
  min_count?: number;
  ...
  @ToInt({
    required: false,
    min: 1,
    description: 'Maximum beds count',
    example: 1,
  })
  max_count?: number;
}
