    ...
    <div className={classes.list}>
      ...
      {type === "table" ? (
        <table className={classes.list_table}>
          ...
          />
          <tbody
            className={`${is_loaded ? classes.loaded : ""} ${!show_shimmer && !is_loaded ? classes.transitioning : ""}`}
          >
            {!is_loaded
        ...
        <div
          className={`${classes.list_cards} ${is_loaded ? classes.loaded : ""} ${!show_shimmer && !is_loaded ? classes.transitioning : ""}`}
        >
          {!is_loaded
            ? Array.from({ length: shimmer_count }).map((_, index) => (
                <div
