...
interface TransferDetailsFiltersMenuProps {
  ...
  updateFilters: (filters: Partial<TransferDetailsFilters>) => void;
}

export const TransferDetailsFiltersMenu = ({ filters, updateFilters }: TransferDetailsFiltersMenuProps) => {
