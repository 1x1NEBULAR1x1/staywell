...
export const BookingCard = ({ booking }: { booking: ExtendedBooking }) => {
  ...
  const nightsCount = calculateDaysDifference(
        ...
        <div className={classes.booking_card_image_container}>
          ...
          <div className={classes.booking_card_image_overlay}>
            ...
            <span className={classes.booking_card_image_subtitle}>
              {booking.booking_variant.apartment.floor} -{" "}
        ...
        <div className={classes.booking_card_content}>
          <div className={classes.booking_card_dates}>
            <span>
              ...
              -{" "}
              {new Date(booking.end).toLocaleDateString("en-GB", {
                day: "2-digit",
                month: "2-digit",
                year: "numeric",
              })}
          ...
          <div className={classes.booking_card_days}>{nightsCount} Days</div>
          ...
          <div className={classes.booking_card_payment_section}>
            <div className={classes.booking_card_payment_item}>
              <span className={classes.booking_card_payment_label}>
                Initial Payment
              </span>
              <span className={classes.booking_card_payment_value}>
          ...
          <div className={classes.booking_card_footer}>
            <span
              className={`${classes.booking_card_status_badge} ${classes[`booking_card_status_${booking.status.toLowerCase()}`]}`}
            >
              {booking.status}
            </span>
            <button
  ...
  return (
    <div className={classes.booking_card}>
      ...
      <div className={classes.booking_card_content}>
        <div className={classes.booking_card_dates}>
          <Shimmer
            style={{ width: "150px", height: "14px", borderRadius: "4px" }}
          />
        </div>
