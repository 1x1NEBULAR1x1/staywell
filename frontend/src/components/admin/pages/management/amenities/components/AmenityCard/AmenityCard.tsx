...
import type { Amenity, ExtendedAmenity } from "@shared/src";
...
export const AmenityCard = ({
  ...
  <tr
    className={classes.amenity_row}
    onClick={() => setEditAmenityData(amenity)}
  >
    <td>
    ...
    <td className={classes.amenity_row_created}>
      {new Date(amenity.created).toDateString()}
    </td>
  </tr>
);
