...
export const ReservationCard = ({
  ...
  return (
    <Link
      ...
      className={classes.reservation_card_link}
    >
      <div className={classes.reservation_card}>
          ...
          <div className={classes.image_overlay}>
            <div className={classes.apartment_info}>
              ...
              <div className={classes.apartment_location}>
                <MapPin size={14} />
                <span>
                  Floor {reservation.apartment.floor}, Room{" "}
        ...
        <div className={classes.content_section}>
          <div className={classes.dates_section}>
            <div className={classes.date_item}>
              ...
              <div className={classes.date_details}>
                ...
                <span className={classes.date_value}>
          ...
          <div className={classes.footer_section}>
            <span className={classes.reservation_id}>
              ID: {reservation.id.slice(-8).toUpperCase()}
            </span>
            <span className={classes.created_date}>
              Created: {format(new Date(reservation.created), "MMM dd, yyyy")}
            </span>
          </div>
        </div>
      </div>
