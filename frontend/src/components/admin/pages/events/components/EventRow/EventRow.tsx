...
export const EventRow = ({ event }: { event: ExtendedEvent }) => {
  ...
  return (
    ...
    >
      ...
      <td>
        <span className={classes.event_row_type}>{event.capacity}</span>
      </td>
      <td className={classes.event_row_created}>
...
export const EventRowShimmer = () => (
  <tr className={classes.event_row}>
    ...
    <td>
      <Shimmer
        style={{ width: "110px", height: "24px", borderRadius: "4px" }}
      />
    </td>
    <td>
      <Shimmer
