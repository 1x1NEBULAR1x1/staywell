    ...
    !!apartment && (
      <div className={classes.meta}>
        <div className={classes.badges_row}>
          <span
            className={`${classes.status} ${apartment.is_available ? classes.available : classes.unavailable}`}
          >
          ...
          {apartment.is_smoking ? (
            ...
            >
              <CigaretteOff
                className={clsx(classes.icon, classes.icon_not_allowed)}
              />
            </ToolTip>
          )}
        ...
        <div className={classes.info_grid}>
          ...
          <div className={classes.info_item}>
            ...
            <div className={classes.info_content}>
              ...
              <span className={classes.info_value}>
                Up to {apartment.max_capacity || apartment.capacity} guests
              </span>
            </div>
          </div>
          ...
          <div className={classes.info_item}>
            ...
            <div className={classes.info_content}>
              ...
              <span className={classes.info_value}>
                {apartment.rating.toFixed(1)} ({apartment.reviews.length}{" "}
                reviews)
              </span>
            </div>
          </div>
          ...
          <div className={classes.info_item}>
            ...
            <div className={classes.info_content}>
              ...
              <span className={classes.info_value}>
                {apartment.apartment_beds.length} beds,{" "}
                {apartment.apartment_amenities.length} amenities
              </span>
            </div>
          </div>
        </div>
