...
export const AdvancedFilters = ({
  ...
  return (
    <div className={classes.container} ref={dropdownRef}>
      <button
        className={`${classes.filter_button} ${hasActiveFilters ? classes.button_active : ""}`}
        onClick={onToggle}
      >
        ...
        <div className={classes.text_content}>
          ...
          <span
            className={`${classes.value} ${!hasActiveFilters ? classes.placeholder : ""}`}
          >
            {getFiltersText()}
          </span>
        </div>
        ...
        <div className={classes.dropdown}>
          <div className={classes.header}>
            ...
            <div className={classes.header_actions}>
              {hasActiveFilters && (
                <button className={classes.reset_button} onClick={handleReset}>
                  <RotateCcw size={16} />
                  Reset
                </button>
              )}
