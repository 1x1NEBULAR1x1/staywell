...
import type { BookingStep } from "@/components/public/pages/apartments/[id]/booking/config";
  ...
  return (
    <div className={classes.actions}>
      ...
      <Link
        href={
          previous_step
            ? `/apartments/${id}/booking/${previous_step}`
            : `/apartments/${id}`
        }
      ...
      {!!previous_step && (
        <Link href={`/apartments/${id}`} className={classes.cancel_button}>
          <Undo2 />
          Cancel
        </Link>
      )}
